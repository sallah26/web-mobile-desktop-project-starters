...
>(({ className, getLabel, children, ...props }, ref) => {
    ...
    >
      {value.map((item, index) => (
        <Badge
          ...
          color={'secondary'}
        >
          <span className="text-xs">{getLabel ? getLabel(item) : item}</span>
          <button
            aria-label={`Remove ${getLabel ? getLabel(item) : item} option`}
          ...
          >
            <span className="sr-only">
              Remove {getLabel ? getLabel(item) : item} option
            </span>
